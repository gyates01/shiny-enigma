...
def _scrape_with_library(url: str) -> dict:
    ...
    return {
        "title": _safe_call(lambda: scraper.title(), default=""),
        "description": _safe_call(lambda: scraper.description(), default=""),
        "servings": _safe_call(lambda: scraper.yields(), default=""),
        "prep_time": _minutes(_safe_call(lambda: scraper.prep_time())),
        "cook_time": _minutes(_safe_call(lambda: scraper.cook_time())),
        "total_time": _minutes(_safe_call(lambda: scraper.total_time())),
        "ingredients": _coerce_list(_safe_call(lambda: scraper.ingredients(), default=[])),
        "instructions": _coerce_list(_safe_call(lambda: scraper.instructions_list(), default=[])),
        "image_url": _safe_call(lambda: scraper.image(), default=""),
        "cuisine": _safe_call(lambda: scraper.cuisine(), default=""),
        "category": _safe_call(lambda: scraper.category(), default=""),
        "tags": _coerce_list(_safe_call(lambda: scraper.tags(), default=[])),
